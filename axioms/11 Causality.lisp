...
;; (cause e1 e2):              Eventuality or agent e1 causes eventuality
;;                                e2.
;; (agent a):                  a is an agent.
;; (agentOf a e):              Agent a is the agent or cause of
;;                                eventuality e.
...
;; (sourceOf x e):             e is a change in an “at” relation and x is
;;                                the location of the initial “at”
;;                                relation.
;; (terminusOf x e):           e is a change in an “at” relation and x is
;;                                the location of the final “at”
;;                                relation.
...
;;                                complex s for eventuality e2 but not
;;                                the cause of e2.
;; (enable e1 e2):             Eventuality e1 is a member of every causal
;;                                complex for eventuality e2 but not the
;;                                cause of e2.
;; (allow e1 e2):              e1 doesn't cause not e2.
;; (prevent e1 e2):            e1 causes not e2.
;; (partiallyCause e1 e2):     e1 together with something else causes
;;                                e2.
...
;; (able a e c):               Agent a is able to do e under constraints
;;                                c.
;; (ability e1 a e c):         e1 is agent a's ability to do e under
;;                                constraints c.
;; (dcause e1 e2):             Eventuality or agent e1 directly causes
;;                                eventuality e2 without any intermediate
;;                                causes.
;; (enabled s e):              All the enabling conditions for causal
;;                                complex s resulting in eventuality e
;;                                hold.
